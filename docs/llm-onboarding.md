...
- consistency между generated routes, handlers и endpoint bindings теперь проверяется в default `verify`, но это всё ещё verify-time guard, а не отдельный generator module
