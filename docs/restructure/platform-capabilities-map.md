...
Этот документ фиксирует, как следует трактовать текущий код проекта в модели простых reusable-блоков.
...
- любой новый широкий support-каталог, если он снова начнёт играть роль архитектурного центра;
...
Трактовать как маленький generic add-on для request logging, а не как отдельную аналитическую платформу.
