...
final class EndpointGeneratorTest extends TestCase
{
    public function testGeneratesEndpointAndHandlerFiles(): void
    {
        ...
        self::assertStringContainsString('Generated by the protocol buffer compiler with protoc-php-gen.  DO NOT EDIT!', $files[0]->getContent());
        self::assertStringContainsString('source: app/v1/health.proto', $files[0]->getContent());
        ...
        self::assertStringContainsString('Generated by the protocol buffer compiler with protoc-php-gen.  DO NOT EDIT!', $files[1]->getContent());
        self::assertStringContainsString('source: app/v1/health.proto', $files[1]->getContent());
