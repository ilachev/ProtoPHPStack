...
use App\Capabilities\Session\Domain\Session as DomainSession;
...
final class SessionProtoMapper
{
     ...
     * @return DomainSession Domain entity
     */
    public function hydrate(\V1Session $proto): \DomainSession
    {
     ...
     *
     * @param DomainSession $entity Domain entity
     * @return V1Session Proto message
     */
    public function extract(\DomainSession $entity): \V1Session
    {
        $proto = new V1Session();
