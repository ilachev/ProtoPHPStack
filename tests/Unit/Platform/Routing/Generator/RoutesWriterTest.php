...
final class RoutesWriterTest extends TestCase
{
    ...
    public function testGenerateRoutesFile(): void
    {
        ...
        self::assertStringContainsString('use App\Platform\Http\Handler\HandlerInterface;', $content);
        self::assertStringContainsString('use App\Examples\Test\Transport\Http\TestHandler;', $content);
        self::assertStringContainsString('use App\Examples\User\Transport\Http\UserHandler;', $content);
        ...
        self::assertStringContainsString('\'handler\' => TestHandler::class', $content);
        ...
        self::assertStringContainsString('\'handler\' => UserHandler::class', $content);
